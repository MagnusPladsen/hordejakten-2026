...
const VISNINGER: { id: string; navn: string; tekst: string; lag: LagId[] }[] = [
  ...
  { id: 'felt', navn: 'Ute i felt', tekst: 'Parkering, letestopp, steder og feltnotater', lag: ['hintmarkorer', 'felt', 'hoyde891', 'dn_plan', 'dn_steder', 'dn_notater', 'dn_gasoner', 'dn_skytefelt', 'utenfor'] },
  ...
  { id: 'vaer', navn: 'Vær og fly', tekst: 'Skyer, sol, regn og flyene hun så', lag: ['skydekke', 'solidag', 'fly', 'dn_flyhendelser', 'dn_regn', 'dn_radar', 'utenfor'] },
]

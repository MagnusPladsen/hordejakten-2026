...
const VISNINGER: { id: string; navn: string; tekst: string; lag: LagId[] }[] = [
  ...
  { id: 'felt', navn: 'Ute i felt', tekst: 'Parkering, letestopp og feltnotater', lag: ['hintmarkorer', 'felt', 'hoyde891', 'dn_plan', 'dn_notater', 'utenfor'] },
  { id: 'defaultno', navn: 'default.no sine funn', tekst: 'Letestopp, avviste områder og høydebånd', lag: ['dn_plan', 'dn_avvist', 'dn_notater', 'dn_hoyde', 'utenfor'] },
  { id: 'vaer', navn: 'Vær og fly', tekst: 'Skyer, sol og flyet hun så', lag: ['skydekke', 'solidag', 'fly', 'utelukket', 'utenfor'] },
]

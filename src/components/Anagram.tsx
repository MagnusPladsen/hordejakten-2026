    ...
    <div className="space-y-4">
      <div className="rounded-xl bg-slate-50 p-3">
        ...
        <p className="mt-2 text-[14px]">
          Går nøyaktig opp i <b>{data.fasit}</b>. THE SHOPLIFTER kan være en hilsen til BobTheShoplifter (default.no), FILTER THE SHOP kan bety å se gjennom butikken i Horde-appen (den har ikke noe filter), og HELHET FOR TIPS at hintene skal ses samlet.
        </p>
      </div>
